...
[Serializable]
public sealed class ExperienceBalance
{
    public List<int> LevelThresholds = new();
    public CrystalValues CrystalValues = new();
    public int CrystalMergeThreshold;
    public float CrystalMergeDistance;
}

[Serializable]
public sealed class CrystalValues { public int Small; public int Medium; public int Large; }

[Serializable]
public sealed class CombatBalance
{
    public float DamageVarianceMin = 0.95f;
    public float DamageVarianceMax = 1.05f;
    public float InvincibilityDuration;
    public float KnockbackForce;
    public int MaxDamageNumbersPerSecond;
}
...
[Serializable]
public sealed class SpawnBalance
{
...
{
    public int DesktopMaxEnemies = 500;
    public int MobileMaxEnemies = 200;
    public float SpatialHashCellSize = 96f;
    public int OffscreenUpdateInterval = 3;
}
